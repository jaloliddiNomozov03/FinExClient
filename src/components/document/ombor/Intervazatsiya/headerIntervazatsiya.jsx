...
import {Button, Row, Col, Space, Input, Modal, Form, Select, InputNumber, DatePicker, notification} from "antd";
...
const HeaderInter = (props) => {
    ...
    const onFinishCreate = (values) => {
        ...
        if (inventory.branchId && inventory.currencyId && inventory.staffId && inventory.warehouseId
        && inventory.allSum && inventory.costs && inventory.enteringSum && inventory.date){
