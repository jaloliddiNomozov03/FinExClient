...
import {Button, Row, Col, Space, Input, Modal, Form, Checkbox, Radio, Select, notification} from "antd";
...
const HeaderBank = (props) => {
    ...
    const onFinishCreate = (values) => {
        ...
        if (bankArrival.responsibleId&&bankArrival.currencyId&&bankArrival.branchId&&bankArrival.objectBankAccountId&&
        bankArrival.objectCompanyId&&bankArrival.objectCounterPartyId&&bankArrival.sectionsId&&bankArrival.retailAmount&&
        bankArrival.sumDP){
            console.log("Ishladi");
...
// Bu pasdagilar Select uchun funksiyalar
    ...
    return (
        <Row>
            ...
            <Col span={4} offset={20} className="search">
                <Space>
                    <Search
