...
import {deleteBankArrival, getBankArrivalPage} from "../../../../server/config/document/BankArrivalService";
...
const PrixodBank = () => {
    ...
    const columns = [
        ...
        { title: "Bank Xisob Raqamlari", dataIndex: "objectBankAccount", key: "objectBankAccount",  },
        { title: "SumDP", dataIndex: "sumDP", key: "sumDP",  },
        { title: "isCounterParty", dataIndex: "isCounterParty", key: "isCounterParty",
            render: (record) => <Checkbox type='checkbox' checked={record} />
        },
        { title: "isConstanta", dataIndex: "isConstanta", key: "isConstanta",
            render: (record) => <Checkbox type='checkbox' checked={record} />
        },
        { title: "SumEnumeration", dataIndex: "sumEnumeration", key: "sumEnumeration",  },
        { title: "SumCounterParty", dataIndex: "sumCounterParty", key: "sumCounterParty",  },
        { title: "PercentEnumeration", dataIndex: "percentEnumeration", key: "percentEnumeration",  },
        ...
        { title: "objectCounterParty", dataIndex: "objectCounterParty", key: "objectCounterParty",  },
...

        {
            ...
            key: "x",
            // width: '7%',
            render: (record) => <button onClick={()=>deleteBankArrivalById(record)}>Delete</button>,
        },
    ];
  return (
      <>
          <HeaderBank getBankArrivals={getBankArrivals}/>
